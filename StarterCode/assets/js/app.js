...
d3.csv("../data/data.csv")
  .then(function(povertyData) {
    ...
    var yLinearScale = d3.scaleLinear()
      .domain([0, d3.max(povertyData, d => d.noHealthInsurance)])
      .range([height, 0]);
    ...
    .attr("fill", "pink")
    .attr("opacity", ".5");
    var theCircles = svg.selectAll("g theCircles").data(povertyData).enter();
    theCircles
       .append("circle")
    theCircles
       .append("text")
    var text = chartGroup.selectAll("t")
      ...
      var textLabels = text
        ...
        .attr("y", function(d) { return  yLinearScale(d.noHealthInsurance) +2})
   ...
   // });
    ...
    var toolTip = d3.tip()
      ...
      .offset([80, -60])
      .html(function(d) {
        return (`${d.state}<br>poverty is : ${d.poverty}<br>Lack of Insurance: ${d.noHealthInsurance}`);
      });
